...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi api) {
    ...
    {
      const BasicMessageChannel<Object> channel =
          BasicMessageChannel<Object>('dev.flutter.pigeon.VideoPlayerApi.setPausePoints', StandardMessageCodec());
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.setPausePoints was null. Expected PausePointsMessage.');
          final PausePointsMessage input = PausePointsMessage.decode(message);
