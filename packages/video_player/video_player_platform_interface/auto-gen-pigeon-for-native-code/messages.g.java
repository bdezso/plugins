...
public class messages.g {
  ...
  public static class PausePointsMessage {
    ...
    private ArrayList pausePointsMs;
    public ArrayList getPausePointsMs() { return pausePointsMs; }
    public void setPausePointsMs(ArrayList setterArg) { this.pausePointsMs = setterArg; }
    ...
    static PausePointsMessage fromMap(HashMap map) {
      PausePointsMessage fromMapResult = new PausePointsMessage();
      Object textureId = map.get("textureId");
      fromMapResult.textureId = (textureId == null) ? null : ((textureId instanceof Integer) ? (Integer)textureId : (Long)textureId);
      Object pausePointsMs = map.get("pausePointsMs");
      fromMapResult.pausePointsMs = (ArrayList)pausePointsMs;
      return fromMapResult;
    }
  }
  ...
  public interface VideoPlayerApi {
    ...
    void setPausePoints(PausePointsMessage arg);
    ...
    static void setup(BinaryMessenger binaryMessenger, VideoPlayerApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.VideoPlayerApi.setPausePoints", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            HashMap<String, HashMap> wrapped = new HashMap<>();
            try {
              @SuppressWarnings("ConstantConditions")
              PausePointsMessage input = PausePointsMessage.fromMap((HashMap)message);
              api.setPausePoints(input);
              wrapped.put("result", null);
            }
            catch (Exception exception) {
              wrapped.put("error", wrapError(exception));
