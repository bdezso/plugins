...
-(NSDictionary*)toMap;
@end
@interface PausePointsMessage ()
+(PausePointsMessage*)fromMap:(NSDictionary*)dict;
-(NSDictionary*)toMap;
@end
...
@implementation PausePointsMessage
+(PausePointsMessage*)fromMap:(NSDictionary*)dict {
  PausePointsMessage* result = [[PausePointsMessage alloc] init];
  result.textureId = dict[@"textureId"];
  if ((NSNull *)result.textureId == [NSNull null]) {
    result.textureId = nil;
  }
  result.pausePointsMs = dict[@"pausePointsMs"];
  if ((NSNull *)result.pausePointsMs == [NSNull null]) {
    result.pausePointsMs = nil;
  }
  return result;
}
-(NSDictionary*)toMap {
...
void VideoPlayerApiSetup(id<FlutterBinaryMessenger> binaryMessenger, id<VideoPlayerApi> api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel
        messageChannelWithName:@"dev.flutter.pigeon.VideoPlayerApi.setPausePoints"
        binaryMessenger:binaryMessenger];
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        PausePointsMessage *input = [PausePointsMessage fromMap:message];
        FlutterError *error;
        [api setPausePoints:input error:&error];
        callback(wrapResult(nil, error));
      }];
    }
    else {
