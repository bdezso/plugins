...
@interface PausePointsMessage : NSObject
@property(nonatomic, strong, nullable) NSNumber * textureId;
@property(nonatomic, strong, nullable) NSArray * pausePointsMs;
@end
...
-(void)setPausePoints:(PausePointsMessage*)input error:(FlutterError *_Nullable *_Nonnull)error;
@end
