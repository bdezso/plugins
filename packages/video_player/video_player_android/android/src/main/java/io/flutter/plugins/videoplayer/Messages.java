...
public class Messages {
  ...
  public static class PausePointsMessage {
    ...
    private @NonNull Long sentTimestampFromFlutter;
    public @NonNull Long getSentTimestampFromFlutter() { return sentTimestampFromFlutter; }
    public void setSentTimestampFromFlutter(@NonNull Long setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"sentTimestampFromFlutter\" is null.");
      }
      this.sentTimestampFromFlutter = setterArg;
    }

    /** Constructor is private to enforce null safety; use Builder. */
    private PausePointsMessage() {}
    public static final class Builder {
      ...
      private @Nullable Long sentTimestampFromFlutter;
      public @NonNull Builder setSentTimestampFromFlutter(@NonNull Long setterArg) {
        this.sentTimestampFromFlutter = setterArg;
        return this;
      }
      public @NonNull PausePointsMessage build() {
        PausePointsMessage pigeonReturn = new PausePointsMessage();
        pigeonReturn.setTextureId(textureId);
        pigeonReturn.setPausePointsMs(pausePointsMs);
        pigeonReturn.setSentTimestampFromFlutter(sentTimestampFromFlutter);
        return pigeonReturn;
      }
    }
    @NonNull Map<String, Object> toMap() {
      ...
      toMapResult.put("pausePointsMs", pausePointsMs);
      toMapResult.put("sentTimestampFromFlutter", sentTimestampFromFlutter);
      return toMapResult;
    }
    static @NonNull PausePointsMessage fromMap(@NonNull Map<String, Object> map) {
      PausePointsMessage pigeonResult = new PausePointsMessage();
  ...
  private static class AndroidVideoPlayerApiCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte)131:         
          return PausePointsMessage.fromMap((Map<String, Object>) readValue(buffer));
    ...
    protected void writeValue(ByteArrayOutputStream stream, Object value)     {
      ...
      if (value instanceof PausePointsMessage) {
        stream.write(131);
        writeValue(stream, ((PausePointsMessage) value).toMap());
      } else 
      ...
      } else 
{
  ...
  public interface AndroidVideoPlayerApi {
    ...
    void setPausePoints(@NonNull PausePointsMessage msg);
    ...
    static void setup(BinaryMessenger binaryMessenger, AndroidVideoPlayerApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.setPausePoints", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ArrayList<Object> args = (ArrayList<Object>)message;
              PausePointsMessage msgArg = (PausePointsMessage)args.get(0);
              if (msgArg == null) {
                throw new NullPointerException("msgArg unexpectedly null.");
              }
              api.setPausePoints(msgArg);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
  ...
  private static class VideoPlayerFlutterApiCodec extends StandardMessageCodec {
    public static final VideoPlayerFlutterApiCodec INSTANCE = new VideoPlayerFlutterApiCodec();
    private VideoPlayerFlutterApiCodec() {}
    @Override
    protected Object readValueOfType(byte type, ByteBuffer buffer) {
      switch (type) {
        case (byte)128:         
      ...
      } else 
{
  ...
  public static class VideoPlayerFlutterApi {
    private final BinaryMessenger binaryMessenger;
    public VideoPlayerFlutterApi(BinaryMessenger argBinaryMessenger){
    ...
    static MessageCodec<Object> getCodec() {
      return VideoPlayerFlutterApiCodec.INSTANCE;
    }

    public void autoPauseHappen(@NonNull PositionMessage msgArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.VideoPlayerFlutterApi.autoPauseHappen", getCodec());
