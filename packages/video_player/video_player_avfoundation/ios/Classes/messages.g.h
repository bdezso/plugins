...
@interface FLTPausePointsMessage : NSObject
...
- (void)setPausePoints:(FLTPausePointsMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
@end
...
/// The codec used by FLTVideoPlayerFlutterApi.
NSObject<FlutterMessageCodec> *FLTVideoPlayerFlutterApiGetCodec(void);

@interface FLTVideoPlayerFlutterApi : NSObject
- (instancetype)initWithBinaryMessenger:(id<FlutterBinaryMessenger>)binaryMessenger;
- (void)autoPauseHappenMsg:(FLTPositionMessage *)msg completion:(void(^)(NSError *_Nullable))completion;
@end
