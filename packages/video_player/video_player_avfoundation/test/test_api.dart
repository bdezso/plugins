...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.AVFoundationVideoPlayerApi.setPausePoints', codec, binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.setPausePoints was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final PausePointsMessage? arg_msg = (args[0] as PausePointsMessage?);
          assert(arg_msg != null, 'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.setPausePoints was null, expected non-null PausePointsMessage.');
          api.setPausePoints(arg_msg!);
          return <Object?, Object?>{};
        });
      }
    }
